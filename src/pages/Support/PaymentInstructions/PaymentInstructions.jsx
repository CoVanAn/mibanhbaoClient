        ...
        <div className="paymentinstructions-container">
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        <li>Trước tiên, khi bạn đặt hàng trực tuyến, bạn sẽ được yêu cầu chọn phương thức thanh toán. Phổ biến nhất là thẻ tín dụng/debit, ví điện tử (như Momo, ZaloPay, PayPal), hoặc chuyển khoản ngân hàng.</li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li>Sau khi thanh toán thành công, bạn sẽ nhận được một email xác nhận đơn hàng hoặc giao dịch, cùng với thông tin chi tiết về đơn hàng và số tiền đã thanh toán.</li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li>Theo dõi tình trạng đơn hàng hoặc giao dịch của bạn thông qua email xác nhận và tài khoản của bạn trên trang web cửa hàng.</li>
                    </ul>
                </li>
                <li>
                    <strong>7. Liên Hệ Hỗ Trợ:</strong>
                    <ul>
                        <li>Nếu có bất kỳ vấn đề nào liên quan đến thanh toán, hãy liên hệ với dịch vụ khách hàng của cửa hàng để được hỗ trợ.</li>
                    </ul>
                </li>
            </ul>
            <p>
                Nhớ rằng việc thanh toán trực tuyến an toàn và dễ dàng hơn khi bạn tuân thủ các biện pháp bảo mật và sử dụng phương thức thanh toán đáng tin cậy.
            </p>
        </div>
    );
};
